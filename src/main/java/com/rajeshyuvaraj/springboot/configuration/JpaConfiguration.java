package com.rajeshyuvaraj.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.rajeshyuvaraj.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.rajeshyuvaraj.springboot.model" });
